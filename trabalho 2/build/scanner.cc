#line 2 "/tmp/guest-p9c5vv/Downloads/simples_compilador/build/scanner.cc"

#line 4 "/tmp/guest-p9c5vv/Downloads/simples_compilador/build/scanner.cc"
...
void *Simplesalloc (yy_size_t  );
void *Simplesrealloc (void *,yy_size_t  );
void Simplesfree (void *  );
...
static yyconst flex_uint16_t yy_nxt[24] =
    {   0,
        4,   14,   14,   13,   12,   11,   10,    9,    8,    7,
        6,   14,    5,    5,    3,   14,   14,   14,   14,   14,
       14,   14,   14
    } ;

static yyconst flex_int16_t yy_chk[24] =
    {   0,
       15,    0,    0,   12,   11,   10,    9,    8,    7,    6,
        5,    3,    2,    1,   14,   14,   14,   14,   14,   14,
       14,   14,   14
    } ;
...
*/
/* Abbreviations.  */
#line 565 "/tmp/guest-p9c5vv/Downloads/simples_compilador/build/scanner.cc"
...
#line 765 "/tmp/guest-p9c5vv/Downloads/simples_compilador/build/scanner.cc"
...
ECHO;
	YY_BREAK
#line 865 "/tmp/guest-p9c5vv/Downloads/simples_compilador/build/scanner.cc"
...
{
	delete [] yy_state_buf;
	Simplesfree(yy_start_stack  );
	yy_delete_buffer( YY_CURRENT_BUFFER );
	Simplesfree(yy_buffer_stack  );
}
...
/* %endif */
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					Simplesrealloc((void *) b->yy_ch_buf,b->yy_buf_size + 2  );
				}
			else
	...
	if ((int) ((yy_n_chars) + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) Simplesrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size  );
...
/* %endif */
{
	...
	b = (YY_BUFFER_STATE) Simplesalloc(sizeof( struct yy_buffer_state )  );
	if ( ! b )
	 ...
	 */
	b->yy_ch_buf = (char *) Simplesalloc(b->yy_buf_size + 2  );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in yy_create_buffer()" );
...
/* %endif */
{
	...
	if (!(yy_buffer_stack)) {
		...
		(yy_buffer_stack) = (struct yy_buffer_state**)Simplesalloc
	...
	if ((yy_buffer_stack_top) >= ((yy_buffer_stack_max)) - 1){
		...
		(yy_buffer_stack) = (struct yy_buffer_state**)Simplesrealloc
								((yy_buffer_stack),
								num_to_alloc * sizeof(struct yy_buffer_state*)
								);
		if ( ! (yy_buffer_stack) )
...
/* %endif */
{
		...
		if ( ! (yy_start_stack) )
			(yy_start_stack) = (int *) Simplesalloc(new_size  );

		else
			(yy_start_stack) = (int *) Simplesrealloc((void *) (yy_start_stack),new_size  );
...
void *Simplesalloc (yy_size_t  size )
{
			return (void *) malloc( size );
}

void *Simplesrealloc  (void * ptr, yy_size_t  size )
{
...
void Simplesfree (void * ptr )
{
			free( (char *) ptr );	/* see Simplesrealloc() for (char *) cast */
}
